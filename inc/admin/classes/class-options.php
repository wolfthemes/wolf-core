...
/**
 * Wolf_Core_Options class.
 */
class Wolf_Core_Options {

	/**
	 * @var settings id
	 */
	private $settings_id = 'wolf-core-settings';
	...
	public function setting_field( $args ) {
		...
		if ( 'text' == $type || 'url' == $type ) {
			?>
			<input placeholder="<?php echo esc_attr( $placeholder ); ?>" value="<?php echo esc_attr( wolf_core_get_option( $settings_slug, $field_id ) ); ?>" name="<?php echo esc_attr( $settings_slug . '[' . $field_id . ']' ); ?>" class="regular-text">
			<?php
			...
			<label>
				<input type="checkbox" name="<?php echo esc_attr( $settings_slug . '[' . $field_id . ']' ); ?>" value="1" <?php checked( wolf_core_get_option( $settings_slug, $field_id ), 1 ); ?>>
			</label>
			<?php
		} elseif ( 'colorpicker' == $type ) {
			$colorpicker_id = uniqid( 'wolf-core-settings-colorpicker-' );
			?>
			<script>
			...
			<input id="<?php echo esc_attr( $colorpicker_id ); ?>" value="<?php echo wolf_core_sanitize_color( wolf_core_get_option( $settings_slug, $field_id ) ); ?>" name="<?php echo esc_attr( $settings_slug . '[' . $field_id . ']' ); ?>" class="wolf-core-settings-colorpicker">
			<?php
			...
			<p>
				...
				<input value="<?php echo wolf_core_sanitize_color( $color ); ?>" name="<?php echo esc_attr( $settings_slug . '[' . $field_id . '][color]' ); ?>" class="wolf-core-settings-colorpicker">
			</p>
			<?php
			/**
			 * Bg image
	...
	public function settings_form() {
		...
		<div class="wrap">
			...
			<form action="options.php" method="post">
				<?php wp_nonce_field( 'wolf_core_save_settings_nonce', 'wolf_core_settings_nonce' ); ?>
