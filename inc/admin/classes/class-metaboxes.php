...
if ( ! class_exists( 'Wolf_Metaboxes' ) ) {
	...
	class Wolf_Metaboxes {
		...
		public function render() {
			...
			/* Opening tag */
			echo '<div class="wolf-core-metabox-metabox-tabs-panel">';

			/* Tabs */
			echo '<ul class="wolf-core-metabox-metabox-tabs">';
			...
			echo '<div class="' . $this->sanitize_html_classes( $class ) . '" ' . $data . '>';
				...
				// editor
					...
					// colorpicker
						...
						echo '<input type="text" class="wolf-core-metabox-colorpicker wolf-core-metabox-colorpicker-input" name="' . $field_id . '" id="' . $field_id . '" value="' . $meta . '" />
					...
					<div>
						...
						<img style="max-width:250px;<?php if ( 0 == $meta_img ) echo ' display:none;'; ?>" class="wolf-core-metabox-img-preview" src="<?php echo esc_url( $meta_img_url ); ?>" alt="<?php echo esc_attr( $field_id ); ?>">
					...
					-------------------------------------------*/
						...
						<div>
							...
							<img style="max-width:250px;<?php if ( ! $img ) echo ' display:none;'; ?>" class="wolf-core-metabox-img-preview" src="<?php echo esc_url( $img_url ); ?>" alt="<?php echo esc_attr( $field_id ); ?>">
						...
						<div class="wolf-core-metabox-images-set clearfix">
							...
							foreach ( $attachments as $attachment_id ) :
								...
								if ( $attachment_id ) :
									...
									if ( $thumbnail_url ) {
										?>
										<span class="wolf-core-metabox-image" data-attachment-id="<?php echo absint( $attachment_id ); ?>">
		...
		public function scripts() {
			...
			/* Admin styles */
			wp_enqueue_style( 'wolf-core-metaboxes', WOLF_CORE_URI . '/assets/css/admin/metaboxes' . $suffix . '.css', array(), $version );
			...
			wp_localize_script( 'wolf-core-metaboxes', 'WolfMetaboxesAdminParams', array(
