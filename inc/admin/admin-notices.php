...
function wolf_core_rating_notif_needed() {
	...
	return wolf_core_is_35_days_after_activation() && ! wolf_core_is_freemius_theme();
}

/**
 * Is the active theme a Freemius-licensed theme?
 *
 * Freemius themes ship a vendor/freemius folder.
 *
 * @return bool
 */
function wolf_core_is_freemius_theme() {
	return is_dir( get_template_directory() . '/vendor/freemius' );
}
