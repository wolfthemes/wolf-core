...
if ( ! function_exists( 'wolf_core_get_theme_slug' ) ) {
	...
	function wolf_core_get_theme_slug() {
		$wp_theme = wp_get_theme( get_template() );
	$slug     = esc_attr( sanitize_title_with_dashes( $wp_theme->get( 'TextDomain' ) ) );

		/**
		 * Filters theme slug
		 *
		 * @since Wolf Core 1.0.0
		 */
		return apply_filters( 'wolftheme_theme_slug', $slug );
	}
}
...
<p>Hi! I'm Constantin, the creator behind WolfThemes.</p>

<p>For over 14 years, I’ve been building premium WordPress themes for musicians, artists, creators, and businesses around the world — with more than 35,000 customers trusting WolfThemes for their projects.</p>

<p>My goal is simple: create beautiful, reliable, and easy-to-use themes that help you build a professional website without the hassle.</p>

<p><strong>Thank you for choosing WolfThemes, and I wish you all the best with your project!</strong></p>
