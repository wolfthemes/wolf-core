...
function wolf_core_add_event_type_taxonomy() {
	...
	$theme_slugs = array( 'wolf-supertheme', 'unimate', 'covenant', 'megahertz', 'nordkapp', 'poize', );
...
/**
 * Nordkapp Add custom taxonomies
 */
function nordkapp_add_custom_taxonomy() {

	if ( 'nordkapp' !== wolf_core_get_theme_slug() ) {
		return;
	}

	/* Season taxonomy for Adventures */
	$season_labels = array(
		'name'                       => esc_html__( 'Seasons', 'wolf-core' ),
		'singular_name'              => esc_html__( 'Season', 'wolf-core' ),
		'search_items'               => esc_html__( 'Search Seasons', 'wolf-core' ),
	...
	register_taxonomy( 'adventure_season', array( 'work' ), $season_args );

	/* Difficulty taxonomy for Adventures */
	$difficulty_labels = array(
		'name'                       => esc_html__( 'Difficulty Levels', 'wolf-core' ),
		'singular_name'              => esc_html__( 'Difficulty', 'wolf-core' ),
		'search_items'               => esc_html__( 'Search Difficulty Levels', 'wolf-core' ),
		'popular_items'              => esc_html__( 'Popular Difficulty Levels', 'wolf-core' ),
		'all_items'                  => esc_html__( 'All Difficulty Levels', 'wolf-core' ),
		'edit_item'                  => esc_html__( 'Edit Difficulty', 'wolf-core' ),
		'update_item'                => esc_html__( 'Update Difficulty', 'wolf-core' ),
		'add_new_item'               => esc_html__( 'Add New Difficulty Level', 'wolf-core' ),
		'new_item_name'              => esc_html__( 'New Difficulty Level', 'wolf-core' ),
		'separate_items_with_commas' => esc_html__( 'Separate difficulty levels with commas', 'wolf-core' ),
		'add_or_remove_items'        => esc_html__( 'Add or remove difficulty levels', 'wolf-core' ),
		'choose_from_most_used'      => esc_html__( 'Choose from the most used difficulty levels', 'wolf-core' ),
		'not_found'                  => esc_html__( 'No difficulty levels found', 'wolf-core' ),
		'menu_name'                  => esc_html__( 'Difficulty', 'wolf-core' ),
	);
	...
	register_taxonomy( 'adventure_difficulty', array( 'work' ), $difficulty_args );

	/* Duration taxonomy for Adventures */
	$duration_labels = array(
		'name'                       => esc_html__( 'Durations', 'wolf-core' ),
		'singular_name'              => esc_html__( 'Duration', 'wolf-core' ),
		'search_items'               => esc_html__( 'Search Durations', 'wolf-core' ),
		'popular_items'              => esc_html__( 'Popular Durations', 'wolf-core' ),
		'all_items'                  => esc_html__( 'All Durations', 'wolf-core' ),
		'edit_item'                  => esc_html__( 'Edit Duration', 'wolf-core' ),
		'update_item'                => esc_html__( 'Update Duration', 'wolf-core' ),
		'add_new_item'               => esc_html__( 'Add New Duration', 'wolf-core' ),
		'new_item_name'              => esc_html__( 'New Duration', 'wolf-core' ),
		'separate_items_with_commas' => esc_html__( 'Separate durations with commas', 'wolf-core' ),
		'add_or_remove_items'        => esc_html__( 'Add or remove durations', 'wolf-core' ),
		'choose_from_most_used'      => esc_html__( 'Choose from the most used durations', 'wolf-core' ),
		'not_found'                  => esc_html__( 'No durations found', 'wolf-core' ),
		'menu_name'                  => esc_html__( 'Duration', 'wolf-core' ),
	);
	$duration_args = array(
	...
	register_taxonomy( 'adventure_duration', array( 'work' ), $duration_args );
}
add_action( 'init', 'nordkapp_add_custom_taxonomy' );