    ...
    <meta itemprop="position" content="' . $position++ . '" />';
			...
			if ( $themes_page_id ) {
				$output .= '<li itemprop="itemListElement" itemscope
					...
					href="' . get_permalink( $themes_page_id ) . '"><span itemprop="name">'
					. get_the_title( $themes_page_id ) . '</span></a><meta itemprop="position" content="'
					. $position++ . '" /></li>' . $delimiter;
			}
