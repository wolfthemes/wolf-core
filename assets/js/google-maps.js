...
var WolfCoreGoogleMaps = function( $ ) {
	...
	return {
		...
		init : function () {
			...
			$( ".wolf-core-google-maps" ).each( function() {
				_this.loadMap( this );
			} );
		 ...
		 */
		scrollFix : function () {
			$( ".wolf-core-google-maps-container" ).click( function () {
				$( this ).find( ".wolf-core-google-maps" ).css( "pointer-events", "auto" );
			} );

			$( ".wolf-core-google-maps-container" ).mouseleave( function() {
				$( this ).find( ".wolf-core-google-maps" ).css( "pointer-events", "none" );
			} );
		}
	};
