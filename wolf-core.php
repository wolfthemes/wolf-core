...
if ( ! class_exists( 'Wolf_Core' ) ) {
	...
	final class Wolf_Core {
		 ...
		 * Plugin update
		 *
		 * Checks downloads.wolfthemes.cloud/plugins/wolf-core/info.json for
		 * the latest version, same principle as Wolf_Envato_License_Manager.
		 */
		public function plugin_update() {

			new Wolf_Core_Updater();
		}
	}
