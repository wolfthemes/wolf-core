 ...
 * @return array
 */
function wolf_core_social_icons_custom_params() {

	return apply_filters(
		'wolf_core_social_icons_custom_params',
		array(
			'properties' => array(
				'name'          => esc_html__( 'Social Icons Custom', 'wolf-core' ),
				'description'   => esc_html__( 'A set of icons linked to social profiles', 'wolf-core' ),
				'vc_base'       => 'wolf_core_social_icons_custom',
				'el_base'       => 'social-icons-custom',
