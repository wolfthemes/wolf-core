...
class Elementor_Marquee_Text_Widget extends \Elementor\Widget_Base { // phpcs:ignore
	...
	public function __construct( $data = array(), $args = null ) { // phpcs:ignore
		...
		$this->params = wolf_core_marquee_text_params();
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Marquee_Text_Widget() );
