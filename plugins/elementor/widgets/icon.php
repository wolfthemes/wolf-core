...
class Elementor_Icon_Widget extends \Elementor\Widget_Base { // phpcs:ignore
	...
	public function __construct( $data = array(), $args = null ) { // phpcs:ignore
		...
		$this->params = wolf_core_icon_params();
	...
	protected function render() {
		...
		echo wolf_core_icon( $atts ); // phpcs:ignore
	}
}
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Icon_Widget() );
