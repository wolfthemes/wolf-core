...
class Elementor_Price_List_Widget extends \Elementor\Widget_Base { // phpcs:ignore
	...
	public function __construct( $data = array(), $args = null ) { // phpcs:ignore
		...
		$this->params = wolf_core_price_list_params();
	...
	protected function render() {
		...
		echo wolf_core_price_list( $atts ); // WCS XSS ok.
	}
}
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Price_List_Widget() );
