...
class Elementor_Social_Icons_Custom_Widget extends \Elementor\Widget_Base { // phpcs:ignore
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Social_Icons_Custom_Widget() );
