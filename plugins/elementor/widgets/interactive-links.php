...
class Elementor_Interactive_Links_Widget extends \Elementor\Widget_Base { // phpcs:ignore
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Interactive_Links_Widget() );
