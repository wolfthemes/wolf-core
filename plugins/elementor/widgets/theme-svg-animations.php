...
class Elementor_Theme_SVG_Animations_Widget extends \Elementor\Widget_Base { // phpcs:ignore
	...
	public function __construct( $data = array(), $args = null ) { // phpcs:ignore
		...
		$this->params = wolf_core_theme_svg_animations_params();
	...
	protected function render() {
		...
		echo wolf_core_theme_svg_animations( $atts ); // WCS XSS ok.
	}
}
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor_Theme_SVG_Animations_Widget() );
