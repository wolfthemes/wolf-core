...
function wolf_core_rotating_text( $atts ) {
	...
	$output .= '<svg style="margin-left: -' . absint( absint( $width ) / 4 ) . '; margin-top: -' . absint( absint( $width ) / 4 ) . ';" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="300px" height="100px" viewBox="0 0 300 300" enable-background="new 0 0 300 300" xml:space="preserve">
