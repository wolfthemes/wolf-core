...
#### 22nd September 2026 - Version 2.1.30

-   Fix: prevent broken 404 page output when a rotating text / icon SVG fails to load

#### 31st August 2026 - Version 2.1.29

-   Improvement: enabled the event "Type" taxonomy (we_type) for Poize

#### 14rd August 2026 - Version 2.1.28

-   Fix: don't display rating invite message for wolfthemes.com users
-   Improvement: moved plugin zip file download URL 

#### 23rd June 2026 - Version 2.1.26

-   Fix: prevent error message if the theme is not activated

#### 2nd June 2026 - Version 2.1.25

-   Fix: verification function 
-   Improvement: removed licence validation tab 
-   Improvement: compatiblity with the new Envato License Manager 

#### 15th April 2026 - Version 2.1.21

-   Improvement: better theme name detection 

#### 4th May 2026 - Version 2.1.20

-   Fix: datepicker legacy date format - fix issue with release date format 

#### 24th April 2026 - Version 2.1.19

-   Fix: text marquee animation duration proprety name 

#### 17th April 2026 - Version 2.1.18

-   Improvement: minor styling adjustments 
-   Fix: Gallery masonry layout after Elementor tab switch 

#### 23th March 2026 - Version 2.1.16 

-   Improvement: allow redirect WooCommerce login popup to current page 
-   Improvement: added {{post_author}} shorthand

#### 12th March 2026 - Version 2.1.14

-   Improvement: added CSS filters and Blend mode settings to Marquee text widget
-   Fix: interactive link video_bg_url_fallback debug message 

#### 17th October 2025 - Version 2.1.12

-   Other: Removed SVG upload support for improved security (SVG uploads can be enabled via Elementor settings if needed)
-   Other: New theme compatiblity 

#### 25th November 2025 - Version 2.1.10

-   Improvement: added episode support to Spotify widget  
-   Improvement: added show support to Spotify widget  
-   Fix: custom taxonomies translation domain names  

#### 5th November 2025 - Version 2.1.7

-   Feat: Added custom taxonomy for MegaHertz theme 
